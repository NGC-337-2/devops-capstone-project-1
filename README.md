...
A RESTful Flask microservice for managing customer accounts with CRUD operations, 
implemented using Agile/DevOps practices including TDD, CI/CD, Docker, and Kubernetes.
